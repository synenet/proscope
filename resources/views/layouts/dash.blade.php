...
<head>
    ...
    <link href="{{asset('css/theme.css')}}" rel="stylesheet" media="all">
     <link href="{{asset('css/avilon.css')}}" rel="stylesheet" media="all">
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{route('project.index')}}">
                                <i class="fas fa-shopping-basket"></i>Project</a>
                        </li>
                        <li>
                            <a href="{{route('team.index')}}">
                                <i class="fas fa-shopping-basket"></i>Team</a>
                        </li>
                        <li>
                            <a href="{{route('myteam.index')}}">
                                <i class="fas fa-shopping-basket"></i>My Team</a>
                        </li>
                        <li>
